...
Stocks like AAPL, have 1-minute data available from yfinance after a few days delay.
Without a better near real-time data source, it is not fruitful to work on near
